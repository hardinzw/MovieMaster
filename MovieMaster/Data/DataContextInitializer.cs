            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Theaters.Any())
                {
                    context.Theaters.AddRange(new List<Theater>()
                    {
                        ...
                        {
                            Name = "Theater 1",
                            Logo = "http://dotnethow.net/images/Theaters/Theater-1.jpeg",
                            Description = "This is the description of the first Theater"
                        },
                        new Theater()
                        {
                            Name = "Theater 2",
                            Logo = "http://dotnethow.net/images/Theaters/Theater-2.jpeg",
                            Description = "This is the description of the second Theater"
                        },
                        new Theater()
                        {
                            Name = "Theater 3",
                            Logo = "http://dotnethow.net/images/Theaters/Theater-3.jpeg",
                            Description = "This is the description of the third Theater"
                        },
                        new Theater()
                        {
                            Name = "Theater 4",
                            Logo = "http://dotnethow.net/images/Theaters/Theater-4.jpeg",
                            Description = "This is the description of the fourth Theater"
                        },
                        new Theater()
                        {
                            Name = "Theater 5",
                            Logo = "http://dotnethow.net/images/Theaters/Theater-5.jpeg",
                ...
                if (!context.Actors.Any())
                {
                    context.Actors.AddRange(new List<Actor>()
                    {
                        ...
                        {
                            FullName = "Actor 1",
                            Biography = "This is the Biographygraphy of the first actor",
                        ...
                        {
                            FullName = "Actor 2",
                            Biography = "This is the Biographygraphy of the second actor",
                ...
                if (!context.Producers.Any())
                {
                    context.Producers.AddRange(new List<Producer>()
                    {
                        ...
                        {
                            FullName = "Producer 4",
                            Biography = "This is the Biography of the fourth Producer",
                            ProfilePictureURL = "http://dotnethow.net/images/producers/producer-4.jpeg"
                        },
                        new Producer()
                        {
                            FullName = "Producer 5",
                            Biography = "This is the Biography of the fifth Producer",
